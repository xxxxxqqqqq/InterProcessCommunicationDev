...
int main(int argc, char *argv[])
{
    ...
    // *1*
    CompB_Interface CurrCompInterface;

    // *2*
    my_portgen_port = starting_port+1;
    ...
    // *1*
    CompB_Messages CurrCompMessages;
    ...
    // *2*
    LibB.InitializeRun(execution_time);
    // ******************************************************************************************** //
