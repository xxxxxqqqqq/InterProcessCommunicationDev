...
int main(int argc, char *argv[])
{
    ...
    // *1*
    CompC_Interface CurrCompInterface;

    // *2*
    my_portgen_port = starting_port+2;
    ...
    // *1*
    CompC_Messages CurrCompMessages;
    ...
    // *2*
    LibC.InitializeRun(execution_time);
    // ******************************************************************************************** //
