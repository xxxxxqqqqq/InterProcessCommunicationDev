...
int main(int argc, char *argv[])
{
    ...
    // *1*
    CompE_Interface CurrCompInterface;

    // *2*
    my_portgen_port = starting_port+4;
    ...
    // *1*
    CompE_Messages CurrCompMessages;
    ...
    // *2*
    LibE.InitializeRun(execution_time);
    // ******************************************************************************************** //
