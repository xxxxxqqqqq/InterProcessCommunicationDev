...
#include "CompF_messages.h"
#include "Lib/mylibF.h"
#include "../../build/Components/CompF/CompF.pb.h"

int main(int argc, char *argv[])
{
    // *********************************** INITIALIZATION START *********************************** //
    std::string mycomp = "CompF";
    ...
    // *1*
    CompF_Interface CurrCompInterface;

    // *2*
    my_portgen_port = starting_port+5;
    ...
    // *1*
    CompF_Messages CurrCompMessages;
    ...
    // *2*
    LibF.InitializeRun(execution_time);
    // ******************************************************************************************** //
