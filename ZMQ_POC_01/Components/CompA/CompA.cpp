...
int main(int argc, char *argv[])
{
    ...
    // *1*
    CompA_Interface CurrCompInterface;

    // *2*
    my_portgen_port = starting_port;
    ...
    // *1*
    CompA_Messages CurrCompMessages;
    ...
    // *2*
    LibA.InitializeRun(execution_time);
    // ******************************************************************************************** //
